...
fun TelaCriarMotorista(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Criar Motorista", color = Color.White, fontWeight = FontWeight.Bold) },
                navigationIcon = {
        ...
        Column(
                ...
                Column(modifier = Modifier.padding(24.dp)) {
                    ...
                    Button(
                        onClick = {
                            when {
                                ...
                                !android.util.Patterns.EMAIL_ADDRESS.matcher(email).matches() -> {
                                    ...
                                    mensagem = ""
                                    viewModel.cadastrarMotorista(
                                        nome = nome,
                                        email = email,
                                        senha = senha,
                                        onSuccess = {
                                            mensagem = "Motorista criado com sucesso! Um e-mail de verificação foi enviado."
                                            // Limpa campos
                                            nome = ""
                                            email = ""
                                            senha = ""
                        ...
                        if (isLoading) {
                            ...
                            Text("Criar Motorista", fontWeight = FontWeight.Bold)
                        }
                    }
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    Text(
                        "• O motorista será criado com nível de acesso 2\n" +
                                "• Um e-mail de verificação será enviado automaticamente\n" +
                                "• O motorista deverá verificar o e-mail antes do primeiro login",
